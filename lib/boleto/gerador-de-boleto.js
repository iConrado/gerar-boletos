	...
	GeradorDeBoleto.prototype.gerarPDF = function(args) {
		return new Promise((resolve)=> {
			...
			boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
				...
				const ESPACO_ENTRE_LINHAS = 22;
				const margemBasica = 30;

				// Linha para logo para recibo pagador
				var linhaDrawCabecalhoRecibo = args.offsetRecibo - 10;
				pdf.moveTo(args.ajusteX + margemBasica - 4, args.ajusteY + linhaDrawCabecalhoRecibo)
					.lineTo(args.ajusteX + 571, args.ajusteY + linhaDrawCabecalhoRecibo)
					.lineWidth(1.2)
					.stroke(args.corDoLayout);

				// Linha mensagens
				var linhaDrawMensagens = args.offsetRecibo + 45;
				pdf.moveTo(args.ajusteX + margemBasica - 4, args.ajusteY + linhaDrawMensagens)
					.lineTo(args.ajusteX + 571, args.ajusteY + linhaDrawMensagens)
					.lineWidth(0.3)
					.stroke(args.corDoLayout);
				
				var colunaBanco11 = 154;
				pdf.moveTo(args.ajusteX + colunaBanco11, args.ajusteY + linhaDrawCabecalhoRecibo - 27)
					.lineTo(args.ajusteX + colunaBanco11, args.ajusteY + linhaDrawCabecalhoRecibo)
					.lineWidth(0.3)
					.stroke(args.corDoLayout);

				var colunaBanco12 = colunaBanco11 + 1;
				pdf.moveTo(args.ajusteX + colunaBanco12, args.ajusteY + linhaDrawCabecalhoRecibo - 27)
					.lineTo(args.ajusteX + colunaBanco12, args.ajusteY + linhaDrawCabecalhoRecibo)
					.stroke(args.corDoLayout);

				var colunaBanco13 = colunaBanco12 + 1;
				pdf.moveTo(args.ajusteX + colunaBanco13, args.ajusteY + linhaDrawCabecalhoRecibo - 27)
					.lineTo(args.ajusteX + colunaBanco13, args.ajusteY + linhaDrawCabecalhoRecibo)
					.stroke(args.corDoLayout);

				var colunaBanco14 = colunaBanco13 + 41.5;
				pdf.moveTo(args.ajusteX + colunaBanco14, args.ajusteY + linhaDrawCabecalhoRecibo - 27)
					.lineTo(args.ajusteX + colunaBanco14, args.ajusteY + linhaDrawCabecalhoRecibo)
					.stroke(args.corDoLayout);

				var colunaBanco15 = colunaBanco14 + 1;
				pdf.moveTo(args.ajusteX + colunaBanco15, args.ajusteY + linhaDrawCabecalhoRecibo - 27)
					.lineTo(args.ajusteX + colunaBanco15, args.ajusteY + linhaDrawCabecalhoRecibo)
					.stroke(args.corDoLayout);

				var colunaBanco16 = colunaBanco15 + 1;
				pdf.moveTo(args.ajusteX + colunaBanco16, args.ajusteY + linhaDrawCabecalhoRecibo - 27)
					.lineTo(args.ajusteX + colunaBanco16, args.ajusteY + linhaDrawCabecalhoRecibo)
					.stroke(args.corDoLayout);
				...
				var margemDaLinhaSeparadora = margemBasica,
					divisoresVerticais = (linha4Opcional || linha3) + (2 * margemDaLinhaSeparadora) - 4,
					margemDoSegundoBloco = margemBasica,
				...
				var linha22 = linha21 + ESPACO_ENTRE_LINHAS;
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linhaSeparadora + 20)
					.lineTo(args.ajusteX + 572, args.ajusteY + linhaSeparadora + 20)
					.dash(3, { space: 5 })
					.lineWidth(0.3)
					.stroke(args.corDoLayout);

				var caminhoParaTesoura = path.join(__dirname, 'imagens/tesoura128.png');
				pdf.image(caminhoParaTesoura, args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + linhaSeparadora - 3.2 + 20, {
					width: 10
				});
				...
				args.creditos && pdf.font('Helvetica-Oblique')
					.fontSize(8)
				...
				var zeroLinha = args.offsetRecibo;

				const linhaCabecalhoRecibo = zeroLinha - 30;
				...
				pdf.image(banco.getImagem(), args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + linhaCabecalhoRecibo - 5, {
					height: alturaDoLogotipoDoBanco
				});

				banco.getImprimirNome() && pdf.font('Helvetica-Bold')
					.fontSize(args.tamanhoDaLinhaDigitavel)
					.text(banco.getNome(), args.ajusteX + margemDoSegundoBlocoLayout + 26, args.ajusteY + linhaCabecalhoRecibo, {
						lineBreak: false,
						width: 100,
						align: 'left'
					});
				...
				pdf.font('Helvetica-Bold')
					.fontSize(args.tamanhoDaLinhaDigitavel)
					.text(banco.getNumeroFormatadoComDigito(), args.ajusteX + margemDoSegundoBlocoLayout + 131, args.ajusteY + linhaCabecalhoRecibo, {
						lineBreak: false,
						width: 39.8,
						align: 'center'
					});
				...
				pdf.font('Helvetica-Bold')
					.fontSize(args.tamanhoDaLinhaDigitavel)
					.text(linhaDigitavel, args.ajusteX + margemDoSegundoBlocoLayout + 145, args.ajusteY + linhaCabecalhoRecibo, {
						lineBreak: false,
						width: 400,
						align: 'right'
					});
				...
				var linhaMensagens = zeroLinha + 50;
				pdf.font('Helvetica-Bold')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Instruções / Mensagens:', args.ajusteX + 27, args.ajusteY + linhaMensagens, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				var mensagemY = 12;
				boleto.getMensagens().forEach(function(mensagem, indice) {
					pdf.font('Helvetica')
						.fontSize(args.tamanhoDaFonte)
						.text(mensagem, args.ajusteX + 27, args.ajusteY + linhaMensagens + mensagemY + (indice * (args.tamanhoDaFonte + 2)), {
							lineBreak: true,
							width: 545,
							align: 'left'
						});
				...
				pdf.font('Helvetica-Bold')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('RECIBO DO PAGADOR', args.ajusteX + 277, args.ajusteY + linhaDrawCabecalhoRecibo - 35, {
						lineBreak: false,
						width: 294,
						align: 'right'
					});
				...
				pdf.font('Helvetica')
					.fontSize(args.tamanhoDaFonte)
					.text(datas.getVencimentoFormatado(), args.ajusteX + colunaLateral, args.ajusteY + (terceiraLinha + 2 - args.tamanhoDaFonte + (indice * args.tamanhoDaFonte)), {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'right'
					});

				var quartaLinha = terceiraLinha + 16,
